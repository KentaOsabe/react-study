...
const fetchWeather = async ({ params }) => {
  await sleep(2000);
  const res = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${params.city}&lang=ja&appid=82b3e288cedd5aefda036d8c0628cfb6`);
  ...
  createRoutesFromElements(
    ...
    >
      ...
      <Route path="/weather/:city" element={<WeatherPage />}
        // loader={({ params }) =>
        //   fetch(`https://api.openweathermap.org/data/2.5/weather?q=${params.city}&lang=ja&appid=82b3e288cedd5aefda036d8c0628cfb6`)
        // }
        loader={fetchWeather}
      />
